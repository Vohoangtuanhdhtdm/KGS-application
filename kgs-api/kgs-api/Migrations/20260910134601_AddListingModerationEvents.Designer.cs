...
namespace kgs_api.Migrations
{
    ...
    [Migration("20260910134601_AddListingModerationEvents")]
    partial class AddListingModerationEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.ListingModerationEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ListingModerationEvents", (string)null);
                });

            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.ListingReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.ListingView", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ListingId", "ViewedOn");

                    b.HasIndex("ListingId", "ViewerHash", "ViewedOn")
                        .IsUnique()
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.ListingModerationEvent", b =>
                {
                    ...
                    b.HasOne("kgs_api.Domain.Entity.ApplicationUser", "Moderator")
                        .WithMany()
            ...
            modelBuilder.Entity("kgs_api.Domain.Entity.SubEntity.ListingReport", b =>
                {
                    ...
                    b.HasOne("kgs_api.Domain.Entity.ApplicationUser", "Reporter")
                        .WithMany()
