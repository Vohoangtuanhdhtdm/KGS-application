...
export function AssetStatusBadge({ status }: { status: AssetStatus }) {
  return (
    <Badge variant="outline" className={cn("font-medium", assetTone[status])}>
      {status}
    </Badge>
  );
}
export function ContractStatusBadge({ status }: { status: ContractStatus }) {
  return (
    <Badge variant="outline" className={cn("font-medium", contractTone[status])}>
      {status}
    </Badge>
  );
}
export function UnitStatusBadge({ status }: { status: UnitStatus }) {
  return (
    <Badge variant="outline" className={cn("font-medium", unitTone[status])}>
      {status}
    </Badge>
  );
}
