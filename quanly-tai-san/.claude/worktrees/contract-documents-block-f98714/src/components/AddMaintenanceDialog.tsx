...
export function AddMaintenanceDialog({
  ...
  const handleSave = () => {
    ...
    toast.success("Đã ghi nhận sửa chữa", {
      description: cost > 0 ? "Đã tự động tạo một dòng chi trong Sổ thu chi" : undefined,
    });
    setTitle("");
    setDescription("");
    setEndDate("");
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Chi phí sẽ tự động xuất hiện trong Sổ thu chi của tài sản.
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-3">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="VD: Sơn lại phòng khách"
            />
          </div>
          <div className="space-y-2">
            <Label>Mô tả</Label>
          ...
          <div className="space-y-2">
            ...
            <Select value={contractorId} onValueChange={setContractorId}>
              <SelectTrigger>
                <SelectValue placeholder="Chọn nhà thầu (tuỳ chọn)" />
              </SelectTrigger>
              <SelectContent>
                {contractors.map((c) => (
