...
export const seedAssets: Asset[] = [
  {
    ...
    name: "Nhà phố Quận 7",
    type: "Nhà mặt phố",
    ownershipType: "Sở hữu",
    status: "Đang cho thuê",
    city: "TP. Hồ Chí Minh",
    district: "Quận 7",
    ward: "Phường Tân Phong",
    addressDetail: "123 Nguyễn Thị Thập",
    lat: 10.7297,
    lng: 106.7215,
    area: 120,
    currentValue: 12500000000,
    acquisitionDate: iso(2019, 5, 12),
  ...
  },
  {
    ...
    ward: "Phường 22",
    addressDetail: "720A Điện Biên Phủ, Tháp T3, tầng 55",
    lat: 10.7947,
    lng: 106.7218,
    area: 92,
    currentValue: 8900000000,
    acquisitionDate: iso(2021, 3, 20),
  ...
  },
  {
    ...
    type: "Nhà riêng",
    ownershipType: "Đi thuê",
    status: "Đang cho thuê",
    city: "Hà Nội",
    district: "Quận Cầu Giấy",
    ward: "Phường Dịch Vọng",
    addressDetail: "45/12 Trần Thái Tông",
    lat: 21.0313,
    lng: 105.7834,
    area: 180,
    currentValue: 0,
    acquisitionDate: iso(2023, 8, 1),
  ...
  },
  {
    ...
    ward: "Xã Hựu Thạnh",
    addressDetail: "Lô A12, KDC Hựu Thạnh",
    lat: 10.85,
    lng: 106.4167,
    area: 250,
    currentValue: 2800000000,
    acquisitionDate: iso(2020, 11, 5),
  ...
  },
  {
    ...
    addressDetail: "18 Đường số 10",
    lat: 10.8058,
    lng: 106.7368,
    area: 320,
    currentValue: 32000000000,
    acquisitionDate: iso(2018, 2, 14),
  ...
  },
  {
    ...
    addressDetail: "Tầng 8, 234 Nguyễn Trãi",
    lat: 10.7669,
    lng: 106.6822,
    area: 200,
    currentValue: 0,
    acquisitionDate: iso(2024, 1, 10),
  ...
  },
  {
    ...
    addressDetail: "56 Bạch Đằng",
    lat: 16.0754,
    lng: 108.2229,
    area: 95,
    currentValue: 5200000000,
    acquisitionDate: iso(2017, 6, 30),
...
export const seedContacts: ContactParty[] = [
  ...
  },
  {
    ...
    name: "Bà Lê Thị Hoa",
    phone: "0913444555",
    notes: "Chủ nhà chung cư mini Cầu Giấy",
  },
  {
    id: "c7",
    type: "Chủ nhà",
    ...
    phone: "0918777666",
    notes: "Chủ tòa nhà văn phòng Nguyễn Trãi",
  },
...
export const seedContracts: LeaseContract[] = [
  {
    ...
    direction: "Cho thuê",
    counterpartyId: "c5",
    startDate: iso(2024, 3, 1),
    endDate: iso(2026, 3, 1),
    rentAmount: 45000000,
    paymentCycle: "Hàng tháng",
    paymentDueDay: 5,
    depositAmount: 90000000,
    taxResponsibility: "Người thuê",
  ...
  },
  {
    ...
    direction: "Cho thuê",
    counterpartyId: "c1",
    startDate: iso(2024, 6, 1),
    endDate: inDays(20),
    rentAmount: 5500000,
    paymentCycle: "Hàng tháng",
    paymentDueDay: 3,
    depositAmount: 11000000,
    taxResponsibility: "Chủ nhà",
    status: "Đang hiệu lực",
  },
  {
    id: "k3",
    ...
    direction: "Cho thuê",
    counterpartyId: "c2",
    startDate: iso(2024, 9, 1),
    endDate: iso(2025, 9, 1),
    rentAmount: 6000000,
    paymentCycle: "Hàng tháng",
    paymentDueDay: 3,
  ...
  },
  {
    ...
    direction: "Cho thuê",
    counterpartyId: "c3",
    startDate: iso(2025, 1, 15),
    endDate: iso(2026, 1, 15),
    rentAmount: 6500000,
    paymentCycle: "Hàng tháng",
    paymentDueDay: 15,
  ...
  },
  {
    ...
    direction: "Đi thuê",
    counterpartyId: "c7",
    startDate: iso(2024, 1, 10),
    endDate: iso(2027, 1, 10),
    rentAmount: 35000000,
    paymentCycle: "Quý",
    paymentDueDay: 10,
  ...
  },
  {
    ...
    direction: "Cho thuê",
    counterpartyId: "c4",
    startDate: iso(2022, 3, 1),
    endDate: iso(2024, 3, 1),
    rentAmount: 40000000,
    paymentCycle: "Hàng tháng",
    paymentDueDay: 5,
...
export const seedCashflow: CashFlowEntry[] = (() => {
  ...
  for (let i = 11; i >= 0; i--) {
    ...
    entries.push({
      ...
      category: "Tiền thuê thu vào",
      amount: 5500000,
      occurredAt: new Date(d.getFullYear(), d.getMonth(), 3).toISOString(),
    ...
    if (i % 3 === 0) {
      entries.push({
        ...
        assetId: "a3",
        direction: "Chi",
        category: "Tiền thuê trả chủ nhà",
        amount: 75000000,
        occurredAt: new Date(d.getFullYear(), d.getMonth(), 1).toISOString(),
  ...
  entries.push({
    ...
    amount: 8500000,
    occurredAt: iso(today.getFullYear(), Math.max(1, today.getMonth()), 15),
    description: "Sơn lại mặt tiền",
  ...
  entries.push({
    ...
    category: "Thuế TNCN",
    amount: 27000000,
    occurredAt: iso(today.getFullYear(), 3, 30),
  ...
  entries.push({
    ...
    amount: 850000,
    occurredAt: iso(today.getFullYear(), 5, 10),
  ...
  entries.push({
    ...
    assetId: "a3",
    direction: "Chi",
    category: "Hoá đơn điện",
    amount: 3200000,
    occurredAt: iso(today.getFullYear(), today.getMonth() + 1, 10),
...
export const seedReminders: Reminder[] = [
  {
    id: "r1",
    title: "Thu tiền thuê Nhà phố Quận 7",
    type: "Thu tiền thuê",
    assetId: "a1",
    contractId: "k1",
    dueDate: inDays(3),
  ...
  {
    id: "r2",
    title: "Trả tiền thuê nhà cho bà Hoa (quý)",
    type: "Đóng tiền thuê",
    assetId: "a3",
    contractId: "k5",
    dueDate: inDays(7),
  ...
  {
    id: "r3",
    title: "Hợp đồng HD-2024-002 sắp hết hạn",
  ...
  {
    id: "r4",
    title: "Bảo dưỡng điều hoà biệt thự Thảo Điền",
    type: "Bảo dưỡng",
    assetId: "a5",
    dueDate: inDays(14),
    cycle: "Nửa năm",
  ...
  {
    id: "r6",
    title: "Thanh toán hoá đơn điện chung cư mini",
    type: "Thanh toán hoá đơn",
    assetId: "a3",
    dueDate: inDays(5),
    cycle: "Tháng",
    daysBefore: 3,
  ...
  {
    id: "r7",
    title: "Hợp đồng HD-2024-005 sắp hết hạn",
    type: "Hết hạn hợp đồng",
    assetId: "a6",
    contractId: "k6",
    dueDate: inDays(45),
...
export const seedDocuments: AssetDocument[] = [
  {
    ...
    assetId: "a1",
    type: "Sổ đỏ/sổ hồng",
    name: "GCN QSDĐ Nhà phố Q7.pdf",
    issuedDate: iso(2019, 5, 15),
    fileName: "so-hong-q7.pdf",
  },
  {
    id: "d2",
    assetId: "a1",
    type: "HĐ thuê",
    name: "HĐ thuê Tech Việt 2024.pdf",
    issuedDate: iso(2024, 3, 1),
    expiryDate: iso(2026, 3, 1),
  },
  {
    id: "d3",
    assetId: "a2",
    type: "Sổ đỏ/sổ hồng",
    name: "Sổ hồng Landmark 81.pdf",
  ...
  },
  {
    ...
    assetId: "a3",
    type: "HĐ thuê",
    name: "HĐ thuê lại từ bà Hoa.pdf",
    issuedDate: iso(2023, 8, 1),
    expiryDate: iso(2026, 8, 1),
  },
  {
    id: "d5",
    assetId: "a1",
    type: "HĐ điện",
    name: "HĐ điện EVN.pdf",
    issuedDate: iso(2019, 6, 1),
